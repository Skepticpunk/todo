...
class toDoListDisplay {
  ...
  addEntry = () => {
    const input = new toDoEntryDisplay();
    input.id = "newEntry";
    console.log(input);
  ...
  render() {
    ...
    this.#list.list.forEach((entry) => {
      if (entry instanceof toDoEntry) {
        ...
        const newEntry = new toDoEntryDisplay(entry, this.#subPanel)
...
const projectsDisplay = new projectListDisplay(document.querySelector("#projectList"), "project", document.querySelector("#toDo"), projectLists);
const toDoListDisplay = new toDoListDisplay(document.querySelector("#toDoEntries"), "toDoList", document.querySelector("#toDoDesc"), toDoList1);
